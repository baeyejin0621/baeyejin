...
document.addEventListener("DOMContentLoaded", (event) => {
  ...
  //브라우저 너비가 480 - 786px일 때
  gsap.matchMedia().add("(min-width: 480px) and (max-width: 679px)", () => {
    let tl = gsap.timeline({
      scrollTrigger: {
  ...
  //브라우저 너비가 680 - 879px일 때
  gsap.matchMedia().add("(min-width: 680px) and (max-width: 879px)", () => {
    let tl = gsap.timeline({
      scrollTrigger: {
        trigger: ".sec2 .sec_title",
        start: "0% 40%",
  ...
  //브라우저 너비가 880 - 1578px일 때
  gsap.matchMedia().add("(min-width: 880px) and (max-width: 1578px)", () => {
    let tl = gsap.timeline({
      scrollTrigger: {
        trigger: ".sec2 .sec_title",
        start: "0% 30%",
  ...
  //브라우저 너비 1579px 이상일 때
  gsap.matchMedia().add("(min-width: 1579px)", () => {
    let tl = gsap.timeline({
      scrollTrigger: {
        trigger: ".sec2 .sec_title",
        start: "0% 9%",
